  ...
  <table class="table table-hover bg-white table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex"> <span><a href="profile.php?id=<?=$result['id']?>"><i class="bi bi-eye-fill text-success mx-1"></i></a></span> <span><a href="edit_emp.php?id=<?=$result['id']?>"><i class="bi bi-pencil-square text-primary mx-1"></i></a></span>
